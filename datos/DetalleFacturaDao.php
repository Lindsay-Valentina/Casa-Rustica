...
class DetalleFacturaDao extends Conexion
{
    ...
    {
        $query = "SELECT id_detalle_factura, id_producto, id_factura, nombre_producto, cantidad_producto, valor_unit_producto, 
        total_detalle_factura, fecha_registro FROM detalle_factura";
        self::getConexion();
