        ...
        <hr>
            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="fecha" class="form-control" name="fecha" id="contrasena" placeholder="Valor total factura" require>
                                </div>     
                                <div class="form-group">
                                    <label for="fecha">Fecha de venta</label>
                                    <input type="fecha" class="form-control" name="fecha" id="contrasena" placeholder="Fecha en la que se causó la venta" require>
                                </div>                 
